...
TEST_CASE("(1)ArgsParser initializes member variables correctly [basic]") {
  ...
  char* argv[] = {(char*)"program_name",    (char*)"-i",
                  (char*)"input_file.txt",  (char*)"-o",
                  (char*)"output_file.txt", (char*)"-c",
                  (char*)"config_file.ini"};
...
// different names
TEST_CASE(
    "(2)ArgsParser initializes member variables correctly [different names]") {
  int argc = 7;
  char* argv[] = {(char*)"program_name", (char*)"-i",       (char*)"file.in",
                  (char*)"-o",           (char*)"file.out", (char*)"-c",
                  (char*)"file.config"};
  Parser parser(argc, argv);
...
TEST_CASE(
    "(3)ArgsParser initializes member variables correctly [different order]") {
  int argc = 7;
  char* argv[] = {(char*)"program_name", (char*)"-i",       (char*)"file.in",
                  (char*)"-o",           (char*)"file.out", (char*)"-c",
                  (char*)"file.config"};
...
TEST_CASE("(4)ArgsParser initializes member variables correctly [redundants]") {
  int argc = 9;
  char* argv[] = {(char*)"program_name", (char*)"-o",    (char*)"file.out",
                  (char*)"hello",        (char*)"world", (char*)"-i",
                  (char*)"file.in",      (char*)"-c",    (char*)"file.config"};
  Parser parser(argc, argv);
...
//--help last
TEST_CASE(
    "(12)ArgsParser initializes member variables correctly [--help last]") {
  int argc = 8;
  char* argv[] = {(char*)"program_name", (char*)"-i",       (char*)"file.in",
                  (char*)"-o",           (char*)"file.out", (char*)"-c",
                  (char*)"file.config",  (char*)"--help"};
  Parser parser(argc, argv);
...
//--help middle
TEST_CASE(
    "(13)ArgsParser initializes member variables correctly [--help middle]") {
  int argc = 8;
  char* argv[] = {(char*)"program_name", (char*)"-i",         (char*)"file.in",
                  (char*)"-o",           (char*)"file.out",   (char*)"--help",
                  (char*)"-c",           (char*)"file.config"};
  Parser parser(argc, argv);
...
//--verbose last
TEST_CASE(
    "(16)ArgsParser initializes member variables correctly [--verbose last]") {
  int argc = 8;
  char* argv[] = {(char*)"program_name", (char*)"-i",       (char*)"file.in",
                  (char*)"-o",           (char*)"file.out", (char*)"-c",
                  (char*)"file.config",  (char*)"--verbose"};
  Parser parser(argc, argv);
...
//--verbose and --help
TEST_CASE(
    "(17)ArgsParser initializes member variables correctly [---verbose and "
    "--help]") {
  int argc = 9;
  char* argv[] = {
      (char*)"program_name", (char*)"-i",          (char*)"file.in",
      (char*)"-o",           (char*)"file.out",    (char*)"--verbose",
...
//--v and --h
TEST_CASE(
    "(18)ArgsParser initializes member variables correctly [--v and --h]") {
  int argc = 9;
  char* argv[] = {(char*)"program_name", (char*)"-i",          (char*)"file.in",
                  (char*)"-o",           (char*)"file.out",    (char*)"-h",
...
TEST_CASE("(1)ArgsParser loads config correctly .ini [evrything specified]") {
  ...
  char* argv[] = {(char*)"program_name",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_1.ini",
                  (char*)"-v"};
  Parser parser(argc, argv);
...
TEST_CASE("(2)ArgsParser loads config correctly .ini [defaults]") {
  ...
  char* argv[] = {(char*)"program_name",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_2.ini",
                  (char*)"-v"};
  Parser parser(argc, argv);
...
TEST_CASE("(3)ArgsParser loads config correctly .json [everything specified]") {
  ...
  char* argv[] = {(char*)"program_name",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_1.json",
                  (char*)"-v"};
  Parser parser(argc, argv);
...
TEST_CASE("(4)ArgsParser loads config correctly .json [defaults]") {
  ...
  char* argv[] = {(char*)"program_name",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_2.json",
                  (char*)"-v"};
  Parser parser(argc, argv);
...
TEST_CASE(
    "(5)ArgsParser loads config correctly .json [everything specified, "
    "different order]") {
  int argc = 8;
  char* argv[] = {(char*)"program_name",
                  (char*)"-i",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_3.json",
                  (char*)"-v"};
  Parser parser(argc, argv);
...
TEST_CASE(
    "(6)ArgsParser loads config correctly .json [different worlist filer "
    "order]") {
  {
    int argc = 8;
    char* argv[] = {(char*)"program_name",
                    ...
                    (char*)"output_file.txt",
                    (char*)"-c",
                    (char*)"test_input_files/test_config_4.json",
                    (char*)"-v"};
    Parser parser(argc, argv);

    REQUIRE(parser.getInputFilename() == "input_file.txt");
    REQUIRE(parser.getOutputFilename() == "output_file.txt");
    REQUIRE(parser.getConfigFilename() ==
            "test_input_files/test_config_4.json");
    REQUIRE(parser.isHelp() == false);
    REQUIRE(parser.isVerbose() == true);
...

  {
    ...
    char* argv[] = {(char*)"program_name",
                    ...
                    (char*)"output_file.txt",
                    (char*)"-c",
                    (char*)"test_input_files/test_config_5.json",
                    (char*)"-v"};
    Parser parser(argc, argv);
    ...
    REQUIRE(parser.getOutputFilename() == "output_file.txt");
    REQUIRE(parser.getConfigFilename() ==
            "test_input_files/test_config_5.json");
    REQUIRE(parser.isHelp() == false);
    REQUIRE(parser.isVerbose() == true);
...

  {
    ...
    char* argv[] = {(char*)"program_name",
                    ...
                    (char*)"output_file.txt",
                    (char*)"-c",
                    (char*)"test_input_files/test_config_6.json",
                    (char*)"-v"};
    Parser parser(argc, argv);
    ...
    REQUIRE(parser.getOutputFilename() == "output_file.txt");
    REQUIRE(parser.getConfigFilename() ==
            "test_input_files/test_config_6.json");
    REQUIRE(parser.isHelp() == false);
    REQUIRE(parser.isVerbose() == true);
...
TEST_CASE("(7)ArgsParser loads config correctly .json [diverent values]") {
  ...
  char* argv[] = {(char*)"program_name",
                  ...
                  (char*)"output_file.txt",
                  (char*)"-c",
                  (char*)"test_input_files/test_config_7.json",
                  (char*)"-v"};
  Parser parser(argc, argv);
