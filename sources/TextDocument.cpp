...
TextDocument::TextDocument(const std::string& filename, Dictionary& dictionary) {
...
std::list<Sentence> TextDocument::getSentences() const {
    return sentences_;
}

void TextDocument::parseSentences(const std::string& text, Dictionary& dictionary) {
    sentences_.clear();
